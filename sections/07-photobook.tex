...
% The modern photographs. These carry a plain hairline frame rather than the
% photo corners used above: the corners say "old print mounted in an album",
% which is true of the three scans and not of these.
\albumhead{The Family Album}

\input{assets/images/plates/family-album}
